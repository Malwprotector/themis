...
This is a strong copyleft license. It gives users important freedoms, but it also imposes strict obligations. If you use, copy, modify, distribute, package, host, or integrate this software, you must respect the AGPL.

### You Are Allowed To

You may:

- use Thémis privately;
- study how the program works;
- modify the source code;
- share copies of the original program;
- distribute modified versions;
- sell services, support, packaging, or compiled builds;
- use the program commercially, provided that you comply with the AGPL.

### You Must Do

If you distribute Thémis, a modified version of Thémis, or a larger work based on Thémis, you must:

- keep the copyright notices;
- keep the license notices;
- provide the complete corresponding source code;
- license derivative works under the same AGPL terms;
- clearly state the changes you made;
- include a copy of the AGPL license;
- avoid adding legal or technical restrictions that remove users’ AGPL rights.

If you modify Thémis and make it available as a network service, you must also provide the corresponding source code of the modified version to users interacting with it over the network.

### You Must Not Do

You must not:

- take this AGPL project and turn it into closed-source proprietary software;
- distribute a modified binary without providing the corresponding source code;
- remove the license or copyright notices;
- hide modifications while distributing or hosting a modified version;
- impose additional restrictions that prevent users from exercising their AGPL rights;
